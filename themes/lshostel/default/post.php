 ...
 *
 * If the value is a string, this function will write a single INPUT element. If the value is an array, it will write
 * multiple INPUT elements to recreate the array.
 *
